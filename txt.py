...
def menu_banner():
    ...
    table.add_row("[bold yellow]2",zuht("Sala", "#FF0000", "#FFA500"),zuht("Shin", "#C0FF3E", "#FFB90F"),zuht("Offline ✘", "#FF4040", "#FF0000"),zuht("Đang bảo trì", "#FF4040", "#FF0000"))
    ...
    table.add_row("[bold yellow]4",zuht("Japan", "#00FF00", "#FFFF00"),zuht("NTD", "#C0FF3E", "#FFB90F"),zuht("Offline ✘", "#FF4040", "#FF0000"),zuht("Đang bảo trì", "#FF4040", "#FF0000"))
    table.add_row("[bold yellow]5",zuht("Hangul", "#FF1493", "#FF4500"),zuht("NTD", "#C0FF3E", "#FFB90F"),zuht("Offline ✘", "#FF4040", "#FF0000"),zuht("Đang bảo trì", "#FF4040", "#FF0000"))
